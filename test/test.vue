<template>
  <div>
    <sb-bread>
      <sb-bread-item>首页</sb-bread-item>
      <sb-bread-item href="#">链接</sb-bread-item>
      <sb-bread-item>当前页面</sb-bread-item>
    </sb-bread>
  </div>
  <div>
  ...
  <div>
    <sb-button @click="test(1, $event)"> 基础禁用 </sb-button> 计数是:{{
      count
    }}
  </div>
  ...
  <div>
    <sb-link
      type="default"
      title="这是一个打开我们git的链接"
      href="https://github.com/aiai0603"
      target="_blank"
    >
      这是一个默认链接
    </sb-link>
